...
public abstract class SingleExtensionApplication : ScriptableObject
{
    ...
    /// <summary>
    /// Method that creates a highlight button style for displaying buttons. Loads the style from a ressource file (HighlightButton.guiskin)
    /// </summary>
    /// <returns>
    ...
    /// </summary>
    /// <param name="progress">
    /// The intended progress of the progress bar.
    /// </param>
